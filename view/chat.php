...
if (isset($_SESSION["id"]) && isset($_SESSION["pseudo"]))
    {
    include( "include/header1C.php");

    ?>
    <form method="POST" action="http://localhost/sitePersoMVCobjet/index.php?action=addMessage">  
    ...
    {
    echo 'Veuillez vous connecter en cliquant <a href="http://localhost/sitePersoMVCobjet/view/connexion.php" >ici
    </a> ou t\'inscrire par <a href="http://localhost/sitePersoMVCobjet/view/inscription.php" >là
